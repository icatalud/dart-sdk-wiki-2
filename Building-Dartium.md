# Introduction
These are instructions to check out and build a modified version of Chromium 50 that embeds the DartVM (Dartium 50) the branch "dartium-1+" is based on the Dart 1.25.0-dev.6.0 branch.
